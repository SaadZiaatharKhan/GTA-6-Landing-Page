...
const Hero = () => {
    ...
    useGSAP(() => {
        gsap.set('.mask-wrapper', {
            maskPosition:initialMaskPos, maskSize: initialMaskSize
        });

        gsap.set('.mask-logo', { marginTop: '-100vh', opacity: 0});

        gsap.set('.entrace-message', {marginTop: '0vh'})
        ...
        tl
            ...
            .to('.entrance-message', {
                duration: 1, ease: 'power1.inOut', maskImage: 'radial-gradient(circle at 50% 0vh, black 50%, transparent 100%)'
            }, '<')
